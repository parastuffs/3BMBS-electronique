...
Utilisez un AOP LM358, une diode 1N4148 et une résistance $R_1 = 1 k\Omega$.
...
\Question{
Réalisez le montage en utilisant une résistance $R_2$ de $10 k\Omega$ et une résistance $R_1$ de $1 k\Omega$. Quel gain observez-vous ?
}
{
-10.
...
\Question{
Réalisez le montage et observez la forme de la tension de sortie.
}
{
...
\begin{itemize}
    \item Calculer et représenter graphiquement la période du signal carré qui sera produit par le NE555 pour une tension Vin de 5V (Pin 4 \& 8)
    \item Définir le comportement global du circuit
    \item Exprimer Vr (la tension aux bornes de la résistance) en fonction de la tension d'entrée \footnote{Allez-vous obtenir 10 V en sortie ?}. 
\end{itemize}
}{
...
$V_r = 2 \times V_{in} - 2 \times V_{th} - V_{perte NE555}$
}


\subsection*{Manipulations}
Dans un premier temps, vous allez réaliser sur breadboard le schéma de la Figure \ref{NE555} avec une tension Vin de 5V. 
