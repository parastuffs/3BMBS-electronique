...
{
	La convention utilisée est qu'une erreur de $+\Delta/2$ correspond au fait que la conversion numérique est trop grande par rapport au signal analogique. C'est pour cette raison que le profil de quantification commence à 0 (entrée et sortie superposées) et descend vers $-\Delta/2$.
	\begin{center}
		\includegraphics[width=.7\textwidth]{profil-quatification-conv-corr.jpg}
	\end{center}
}
